...
public class SeleniumFunctions {
  ...
  public void iSetElementWithKeyValue(String element, String key) throws Exception {
    ...
    if (exist) {
      ...
      Assert.assertTrue(
          String.format("The given key %s do not exist in Context", key),
          this.scenarioData.containsKey(key));
    }
  }
  ...
  public boolean isElementDisplayed(String element) throws Exception {
    ...
    try {
      ...
      WebDriverWait wait = new WebDriverWait(driver, EXPLICIT_TIMEOUT);
      isDisplayed =
          wait.until(ExpectedConditions.presenceOfElementLocated(SeleniumElement)).isDisplayed();
  ...
  public void checkPartialTextElementNotPresent(String element, String text) throws Exception {
    ...
    Assert.assertFalse(
        "Text is present in element: " + element + " current text is: " + elementText,
        isFoundFalse);
  }
  ...
  public void checkPartialTextElementPresent(String element, String text) throws Exception {
    ...
    Assert.assertTrue(
        "Text is not present in element: " + element + " current text is: " + elementText, isFound);
  }
